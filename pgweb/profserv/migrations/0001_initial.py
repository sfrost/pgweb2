    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.OneToOneField(db_column=b'organisation_id', to='core.Organisation', help_text=b'If no organizations are listed, please check the <a href="/account/orglist/">organisation list</a> and contact the organisation manager or <a href="webmaster@postgresql.org">webmaster@postgresql.org</a> if none are listed.', verbose_name=b'organization')),
            ],
            options={
                'ordering': ('org__name',),
            },
