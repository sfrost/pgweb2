...
class ProfessionalService(models.Model):
	...
	org =  models.OneToOneField(Organisation, null=False, blank=False,
							...
							help_text="If no organizations are listed, please check the <a href=\"/account/orglist/\">organisation list</a> and contact the organisation manager or <a href=\"webmaster@postgresql.org\">webmaster@postgresql.org</a> if none are listed.")
