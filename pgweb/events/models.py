...
class Event(models.Model):
	...
	org = models.ForeignKey(Organisation, null=False, blank=False, verbose_name="Organization", help_text="If no organizations are listed, please check the <a href=\"/account/orglist/\">organization list</a> and contact the organization manager or <a href=\"mailto:webmaster@postgresql.org\">webmaster@postgresql.org</a> if none are listed.")
